...
from ...integrations import persistence, spl_check, submission_tracing
...
def persist_answers_from_session():
    ...
    is_spl_match = spl_check.check_spl(_nhs_number, _date_of_birth)
    ...
    return submission_reference, is_spl_match
